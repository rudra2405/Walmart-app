...
export default function UpdateProduct() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        addeddate.current.value = response.data.addedate;
  ...
  const UpdateProductsData = async (e) => {
    e.preventDefault();
    ...
    <>
      ...
      <div className="p-0 w-full flex flex-row">
        ...
        <div className="w-full">
          <h1 className="text-3xl ms-5 p-5 mt-2">update Your Products</h1>
          <hr className="border-1 w-55 ms-15" />

          <form
            onSubmit={UpdateProductsData}
